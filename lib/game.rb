  ...
  def judge(card1, card2)
    ...
    if card1_value > card2_value
      ...
      if new_card1_value > new_card2_value
        ...
        return "War! Player 1 took a #{new_card_2.rank} of #{new_card_2.suit} with a #{new_card_1.rank} of #{new_card_1.suit}"
      elsif new_card2_value > new_card1_value
        @player2.deck.add(collection_of_cards)
        return "War! Player 2 took a #{new_card_1.rank} of #{new_card_1.suit} with a #{new_card_2.rank} of #{new_card_2.suit}"
      elsif new_card_1_value == new_card_2new_card2_value
        judge(new_card_1, new_card_2)
      end
    end
  end
